...
${data.message}
    ...
    // Create mailto link
    const mailtoLink = `mailto:dsign.acct@gmail.com?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(emailBody)}`;

    // Open email client
    window.location.href = mailtoLink;

    // Show success message
    formMessage.textContent = 'กำลังเปิดโปรแกรมอีเมลของคุณ... หากไม่ทำงาน กรุณาติดต่อเราโดยตรงที่ dsign.acct@gmail.com';
